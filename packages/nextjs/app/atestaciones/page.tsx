          ...
          <>
            ...
            {attestations?.length > 0 ? (
                              ...
                              <div className="rating rating-md space-x-3">
                                <input
                                  ...
                                  className={`mask mask-star-2 ${
                                    attestation.impact >= 1 ? "bg-accent" : "bg-primary/20"
                                  }`}
                                  value="1"
                                  id="1"
                                ...
                                <input
                                  ...
                                  name="impactRating"
                                  className={`mask mask-star-2 ${
                                    attestation.impact >= 2 ? "bg-accent" : "bg-primary/20"
                                  }`}
                                  value="2"
                                  id="2"
                                ...
                                <input
                                  ...
                                  name="impactRating"
                                  className={`mask mask-star-2 ${
                                    attestation.impact >= 3 ? "bg-accent" : "bg-primary/20"
                                  }`}
                                  value="3"
                                  id="3"
                                ...
                                <input
                                  ...
                                  name="impactRating"
                                  className={`mask mask-star-2 ${
                                    attestation.impact >= 4 ? "bg-accent" : "bg-primary/20"
                                  }`}
                                  value="4"
                                  id="4"
                                ...
                                <input
                                  ...
                                  name="impactRating"
                                  className={`mask mask-star-2 ${
                                    attestation.impact >= 5 ? "bg-accent" : "bg-primary/20"
                                  }`}
                                  value="5"
                                  id="5"
              ...
              <div className="w-full md:w-4/5 flex justify-center py-8 text-xl">
                <p>No fue posible cargar las Atestaciones</p>
              </div>
            )}
          </>
        ) : (
